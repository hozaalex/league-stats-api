      ...
      while (attempts < maxAttempts) {
        ...
        try {
          ...
          if (statusData.status === "COMPLETED") {
            ...
            console.log("Backend marked request as FAILED:", statusData.error);
            return false;
                ...
                {rankedProfile.championPerformance?.length > 0 ? (
                  rankedProfile.championPerformance.map((champ) => (
                    <div key={champ.championId} className="champ-card">
                      ...
                      <p className="muted">
                        Kills: {champ.avgKills.toFixed(2)} Deaths: {champ.avgDeaths.toFixed(2)}{" "}
                        Assists: {champ.avgAssists.toFixed(2)}
                      </p>
